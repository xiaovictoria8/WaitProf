...
/*
#pragma mark - Functions that load courses from the database
-(void)getCourses {
    //request all courses in descending order
    PFQuery *courseQuery = [PFQuery queryWithClassName:@"CourseObject"];
